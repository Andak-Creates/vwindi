    ...
    <section className="relative pt-32 pb-20 px-10 md:px-20 overflow-hidden bg-white text-center">
      ...
      >
        <h1 className="text-5xl md:text-[55px] font-bold leading-[1.01] tracking-tight text-[#111111] mb-8">
          What&apos;s the deal <br /> with{" "}
          <span className="gradient-text">Vwindi?</span>
        </h1>
        <p className="max-w-2xl mx-auto text-lg md:text-md text-[#676767] leading-relaxed mb-5 font-medium">
          ...
          We exist to build the tools of tomorrow while teaching the builders of
          the future.
        </p>
      </motion.div>
    </section>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-[#676767] max-w-2xl mx-auto">
            A tight-knit crew of passionate developers and part-time
            instructors.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="glass-card border border-black/10 rounded-[2rem] p-6 text-center group cursor-pointer hover:-translate-y-2 transition-transform">
            <div className="w-24 h-24 mx-auto bg-gradient-to-tr from-blue-400 to-purple-500 rounded-full mb-4 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
              👨‍💻
            </div>
          ...
          {[1, 2, 3].map((_, i) => (
            <div
              key={i}
              className="glass-card border border-black/10 rounded-[2rem] p-6 text-center opacity-70 group cursor-pointer hover:-translate-y-2 transition-transform"
            >
              <div className="w-24 h-24 mx-auto bg-gray-100 rounded-full mb-4 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                🤝
              </div>
