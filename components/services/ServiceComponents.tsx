  ...
  return (
    <section className="relative pt-32 pb-20 px-10 md:px-20 overflow-hidden bg-[#fdfdfd] text-center border-b border-black/5">
      ...
      >
        ...
        <h1 className="text-4xl md:text-[55px] font-bold tracking-tight text-[#111111] mb-8 leading-[1.01]">
          {title}
        </h1>
        <p className="max-w-2xl mx-auto text-lg md:text-md text-[#676767] leading-relaxed mb-10 font-medium">
          {subtitle}
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {stats.map((stat, i) => (
            ...
            >
              <h3 className="text-4xl font-black text-[#111111] mb-2">
                {stat.value}
              </h3>
              <p className="text-xs text-[#676767] font-bold uppercase tracking-widest">
                {stat.label}
              </p>
            </motion.div>
          ))}
...
export const SectionHeader = ({
  ...
  <div className="max-w-7xl mx-auto px-10 md:px-20 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
